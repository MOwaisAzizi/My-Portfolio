                        ...
                        <p data-aos="fade-up" data-aos-duration="800" style={{ direction: 'rtl' }} className="px-lg-5 mx-lg-5 center px-1  mx-0" >
                          من یک توسعه دهنده فرات اند با دو سال تجربه هستم که در افغانستان، هرات زندگی میکنم و محصل برحال 
                            ...
                            <div className="cvdiv mt-3" data-aos="fade-left" data-aos-delay="300" data-aos-duration="1000">
                                <button style={{background: props.theme === 'dark' ?'#02f5fd': '#8ef7cd',boxShadow:props.theme === 'dark' ? '0px 3px 8px  rgba(85, 200, 204,0.8)':'0px 3px 12px rgba(0,0,0,0.2)'}} className="mb-2 mt-2 btn-primary-cv py-2 px-3" ><a style={{color: props.theme === 'dark' ?'white': 'black',}} href={CV} download='CV' className="a-btn">دانلود سی وی <FaDownload /></a></button>
                            </div>
            </Container>
        </div>
    )
