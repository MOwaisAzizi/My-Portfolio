            ...
            <Container>
                        ...
                        <p data-aos="fade-up" style={{ direction: 'rtl' }} className="px-lg-5 mx-lg-5 center px-1 mx-0" >
                            ...
                            <div className="cvdiv mt-3" data-aos="fade-left" data-aos-delay="300" data-aos-duration="1000">
                                <button style={{background: props.theme == 'dark' ?'#02f5fd': '#8ef7cd',boxShadow:props.theme == 'dark' ? '9px 9px 15px #22abaf':'5px 5px 25px #49bc8e'}} className="mb-2 mt-2 btn-primary-cv py-1 px-3" ><a style={{color: props.theme == 'dark' ?'white': 'black',}} href={CV} download='CV' className="a-btn">دانلود سی وی <FaDownload /></a></button>
                            </div>
                        </p>
            </Container>
        </div>
