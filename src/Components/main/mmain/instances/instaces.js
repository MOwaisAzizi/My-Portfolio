...
<Container className=" contain"> 
   <div className="pb-md-3 pb-1 slider ">
        ...
        <div className="slides" style={{ transform: `translateX(-${ width >= 700 ? currentIndex * 436 : width <700 && width>500 ? currentIndex * 520 :  currentIndex * 365}px)` }}>
 ...
 {Array.from({length:images.length},(_,i)=>i).map((acitve,index)=>{
        ...
        <Container className="">
            <div className="mb-3 mb-md-0  mt-4 me-3 me-sm-0">
              <Link to='/project'>  <button style={style} className="h ms-lg-1 ms-2 py-md-1 More" >See More <span className="arrow">&rarr;</span></button></Link>
            </div>
        </Container>
      </div>
