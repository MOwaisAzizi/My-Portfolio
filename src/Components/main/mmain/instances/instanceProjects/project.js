            ...
            <li className="li" onClick={showlinks1Handler } >
              ...
              {showlinks1 ?
                <div className="backdrop" >
                  <Row>
                    <div className='links'>
                      <Button className="btn btn-light me-1 me-sm-2" data-aos="fade-right" data-aos-duration="500" ><a className="ps-1" href='https://travel-ashy-eight.vercel.app'>Visit<i style={style2} className="fa fa-globe icons"></i></a></Button>
                      <Button className="btn btn-light ms-1 ms-sm-2" data-aos="fade-left" data-aos-duration="500" ><a className="ps-1" href='https://github.com/MOwaisAzizi/travel-list-note'>Github<i style={style2} className="fa fa-github icons"></i></a></Button>
                    </div>
                  </Row>
                </div>
                : null}
            ...
            <li className="li" onClick={showlinks2Handler}>
              ...
              {showlinks2 ?
                <div className="backdrop" >
                  <Row>
                    <div className='links'>
                      <Button className="btn btn-light me-1 me-sm-2" data-aos="fade-right" data-aos-duration="500"><a className="ps-1" href='https://split-eat.vercel.app'>Visit<i style={style2} className="fa fa-globe icons"></i></a></Button>
                      <Button className="btn btn-light ms-1 ms-sm-2" data-aos="fade-left" data-aos-duration="500"><a className="ps-1" href='https://github.com/MOwaisAzizi/Eat-split-app'>Github<i style={style2} className="fa fa-github icons"></i></a></Button>
                    </div>
                  </Row>
                </div>
                : null}
            ...
            <li className="li" onClick={showlinks3Handler}>
              ...
              {showlinks3 ?
                <div className="backdrop" >
                  <Row>
                    <div className='links'>
                      <Button className="btn btn-light me-1 me-sm-2" data-aos="fade-right" data-aos-duration="500"><a className="ps-1" href='http://mowaisazizi.github.io/Countries-Data-App'>Visit<i style={style2} className="fa fa-globe icons"></i></a></Button>
                      <Button className="btn btn-light ms-1 ms-sm-2" data-aos="fade-left" data-aos-duration="500"><a className="ps-1" href='https://github.com/MOwaisAzizi/Countries-Data-App'>Github<i style={style2} className="fa fa-github icons"></i></a></Button>
                    </div>
                  </Row>
                </div>
                : null}
            ...
            <li className='li' onClick={showlinks13Handler} >
              ...
              {showlinks13 ?
                <div className="backdrop" >
                  <Row>
                    <div className='links'>
                      <Button className="btn btn-light me-1 me-sm-2" data-aos="fade-right" data-aos-duration="500"><a className="ps-1" href='https://mowaisazizi.github.io/Pig-Game/'>Visit<i style={style2} className="fa fa-globe icons"></i></a></Button>
                      <Button className="btn btn-light ms-1 ms-sm-2" data-aos="fade-left" data-aos-duration="500"><a className="ps-1" href='https://github.com/MOwaisAzizi/Pig-Game'>Github<i style={style2} className="fa fa-github icons"></i></a></Button>
                    </div>
                  </Row>
                </div>
                : null}
            ...
            <li className="li" onClick={showlinks8Handler}>
              ...
              {showlinks8 ?
                <div className="backdrop" >
                  <Row>
                    <div className='links'>
                      <Button className="btn btn-light me-1 me-sm-2" data-aos="fade-right" data-aos-duration="500"><a className="ps-1" href='http://mowaisazizi.github.io/Calculator/'>Visit<i style={style2} className="fa fa-globe icons"></i></a></Button>
                      <Button className="btn btn-light ms-1 ms-sm-2" data-aos="fade-left" data-aos-duration="500"><a className="ps-1" href='https://github.com/MOwaisAzizi/Calculator'>Github<i style={style2} className="fa fa-github icons"></i></a></Button>
                    </div>
                  </Row>
                </div>
                : null}
            ...
            <li className='li' onClick={showlinks9Handler}>
              ...
              {showlinks9 ?
                <div className="backdrop" >
                  <Row>
                    <div className='links'>
                      <Button className="btn btn-light me-1 me-sm-2" data-aos="fade-right" data-aos-duration="500"><a className="ps-1" href='https://mowaisazizi.github.io/progect1/'>Visit<i style={style2}  className="fa fa-globe icons"></i></a></Button>
                      <Button className="btn btn-light ms-1 ms-sm-2" data-aos="fade-left" data-aos-duration="500"><a className="ps-1" href='https://github.com/MOwaisAzizi/progect1'>Github<i style={style2} className="fa fa-github icons"></i></a></Button>
                    </div>
                  </Row>
                </div>
                : null}
            ...
            <li className='li' onClick={showlinks10Handler}>
              ...
              {showlinks10 ?
                <div className="backdrop" >
                  <Row>
                    <div className='links'>
                      <Button className="btn btn-light me-1 me-sm-2" data-aos="fade-right" data-aos-duration="500"><a className="ps-1" href='http://mowaisazizi.github.io/Note-Management-App/'>Visit<i style={style2} className="fa fa-globe icons"></i></a></Button>
                      <Button className="btn btn-light ms-1 ms-sm-2" data-aos="fade-left" data-aos-duration="500"><a className="ps-1" href='https://github.com/MOwaisAzizi/Note-Management-App'>Github<i style={style2} className="fa fa-github icons"></i></a></Button>
                    </div>
                  </Row>
                </div>
                : null}
            ...
            <li className='li' onClick={showlinks11Handler}>
              ...
              {showlinks11 ?
                <div className="backdrop" >
                  <Row>
                    <div className='links'>
                      <Button className="btn btn-light me-1 me-sm-2" data-aos="fade-right" data-aos-duration="500"><a className="ps-1" href='http://mowaisazizi.github.io/Guess-My-Number/'>Visit<i style={style2} className="fa fa-globe icons"></i></a></Button>
                      <Button className="btn btn-light ms-1 ms-sm-2" data-aos="fade-left" data-aos-duration="500"><a className="ps-1" href='https://github.com/MOwaisAzizi/Guess-My-Number'>Github<i style={style2} className="fa fa-github icons"></i></a></Button>
                    </div>
                  </Row>
                </div>
                : null}
            ...
            <li className='li' onClick={showlinks12Handler} >
              ...
              {showlinks12 ?
                <div className="backdrop" >
                  <Row>
                    <div className='links'>
                      <Button className="btn btn-light me-1 me-sm-2" data-aos="fade-right" data-aos-delay="200"><a className="ps-1" href='https://mowaisazizi.github.io/project-4-of--4/'>Visit<i style={style2} className="fa fa-globe icons"></i></a></Button>
                      <Button className="btn btn-light ms-1 ms-sm-2" data-aos="fade-left" data-aos-delay="200"><a className="ps-1" href='https://github.com/MOwaisAzizi/project-4-of--4'>Github<i style={style2} className="fa fa-github icons"></i></a></Button>
                    </div>
                  </Row>
                </div>
                : null}
