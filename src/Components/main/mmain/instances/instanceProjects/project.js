            ...
            <li className="li" onClick={() => setshowlinks1(!showlinks1)}>
              ...
              {showlinks1 ?
                <div className="backdrop" >
                  <Row>
                    <div className='links'>
                      <Button className="btn btn-light me-2" data-aos="fade-right" data-aos-delay="200"><a href='https://github.com/MOwaisAzizi/Calculator'>Github <i className="fa fa-github icons"></i></a></Button>
            ...
            <li className='li' onClick={() => setshowlinks2(!showlinks2)}>
              ...
              {showlinks2 ?
                <div className="backdrop" >
                  <Row>
                    <div className='links'>
                      <Button className="btn btn-light me-2" data-aos="fade-right" data-aos-delay="200"><a href='https://github.com/MOwaisAzizi/progect1'>Github <i className="fa fa-github icons"></i></a></Button>
            ...
            <li className='li' onClick={() => setshowlinks3(!showlinks3)}>
              ...
              {showlinks3 ?
                <div className="backdrop" >
                  <Row>
                    <div className='links'>
                      <Button className="btn btn-light me-2" data-aos="fade-right" data-aos-delay="200"><a href='https://github.com/MOwaisAzizi/Note-Management-App'>Github <i className="fa fa-github icons"></i></a></Button>
            ...
            <li className='li' onClick={() => setshowlinks4(!showlinks4)}>
              ...
              {showlinks4 ?
                <div className="backdrop" >
                  <Row>
                    <div className='links'>
                      <Button className="btn btn-light me-2" data-aos="fade-right" data-aos-delay="200"><a href='https://github.com/MOwaisAzizi/Guess-My-Number'>Github <i className="fa fa-github icons"></i></a></Button>
            ...
            <li className='li' onClick={() => setshowlinks5(!showlinks5)} >
              ...
              {showlinks5 ?
                <div className="backdrop" >
                  <Row>
                    <div className='links'>
                      <Button className="btn btn-light me-2" data-aos="fade-right" data-aos-delay="200"><a href='https://github.com/MOwaisAzizi/project-4-of--4'>Github <i className="fa fa-github icons"></i></a></Button>
            ...
            <li className='li' onClick={() => setshowlinks6(!showlinks6)} >
              ...
              {showlinks6 ?
                <div className="backdrop" >
                  <Row>
                    <div className='links'>
                      <Button className="btn btn-light me-2" data-aos="fade-right" data-aos-delay="200"><a href='https://github.com/MOwaisAzizi/Pig-Game'>Github <i className="fa fa-github icons"></i></a></Button>
